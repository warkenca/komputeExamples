---
title: "KOMPUTE method testing - BC data"
...
png(file="docs/figure/figures.Rmd/pvca_BC_supp.png", width=700, height=400)
pvca.plots
dev.off()
```
...
png(file="docs/figure/figures.Rmd/cors_BC_supp.png", width=625, height=250)
draw(ht4+ht3)
dev.off()

pdf(file="docs/figure/figures.Rmd/cors_BC_supp.pdf", width=12, height=4.9)
draw(ht4+ht3)
dev.off()
```
...
# Part of Supplementary Figure 3
fig3.1 <- ggplot(imp.sub, aes(x=imp.z, y=org.z, col=info)) +
  geom_point() +
...
save(fig3.1, file="docs/figure/figures.Rmd/sim_BC.rdata")
```
